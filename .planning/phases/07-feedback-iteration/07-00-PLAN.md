...
<task type="auto">
  ...
  <verify>
    <automated>cd /Users/xavierbuise/Dev/experiments/babl/backend && source .venv/bin/activate && python -m pytest tests/test_chunk_overlap.py -x -q 2>&1 | tail -5</automated>
  </verify>
</task>
...
<task type="auto">
  ...
  <verify>
    <automated>cd /Users/xavierbuise/Dev/experiments/babl/backend && source .venv/bin/activate && python -m pytest tests/test_prompt_versioning.py -x -q 2>&1 | tail -5</automated>
  </verify>
</task>
...
<task type="auto">
  ...
  <verify>
    <automated>cd /Users/xavierbuise/Dev/experiments/babl/backend && source .venv/bin/activate && python -m pytest tests/test_user_corrections.py -x -q 2>&1 | tail -5</automated>
  </verify>
</task>
