...
```bash
cd /Users/xavierbuise/Dev/experiments/babl/backend && source .venv/bin/activate && pip install pytest pytest-asyncio
```
...
```bash
cd /Users/xavierbuise/Dev/experiments/babl/backend && source .venv/bin/activate && python -m pytest tests/ -v --tb=short 2>&1 | tail -30
```
...
<verify>
<automated>cd /Users/xavierbuise/Dev/experiments/babl/backend && source .venv/bin/activate && python -m pytest tests/ -v --tb=short 2>&1 | tail -40</automated>
</verify>
...
```bash
cd /Users/xavierbuise/Dev/experiments/babl && npx vitest run src/lib/utils/dedup.test.ts
```
...
<verify>
<automated>cd /Users/xavierbuise/Dev/experiments/babl && npx vitest run src/lib/utils/dedup.test.ts 2>&1 | tail -20</automated>
</verify>
